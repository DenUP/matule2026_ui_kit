              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 20),
                    ui.cardBackground.base(),
                    SizedBox(height: 20),
                    ui.card.primary(
                      title: 'Рубашка Воскресенье для машинного вязания',
                      category: 'Мужская одежда',
                      price: "300",
                      button: ui.smallButton.accent(title: 'Добавить'),
                    ),
                    SizedBox(height: 20),
                    ui.card.primary(
                      title: 'Рубашка Воскресенье для машинного вязания',
                      category: 'Мужская одежда',
                      price: "300",
                      button: ui.smallButton.delButton(title: 'Убрать'),
                    ),
                    SizedBox(height: 20),
                    ui.card.cart(
                      title: "Рубашка воскресенье для машинного вязания",
                    ...
                    ui.orderCard.base(
                      ...
                      productOnePrice: "300",
                      productTwoTitle: "Шорты Вторник для машинного ",
                      productTwoPrice: "690",
                      chekOntap: () {},
                      helpOntap: () {},
                      closeOntap: () {},
